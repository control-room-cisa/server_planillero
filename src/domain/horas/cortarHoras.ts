...
import {
  ...
  horasDesdeMin,
  TZ_DEF,
} from "../politicas-horario/tiempo";
import { IPoliticaHorario } from "../politicas-horario/interfaces";

export abstract class PoliticaBase implements IPoliticaHorario {
  protected tz = TZ_DEF;
