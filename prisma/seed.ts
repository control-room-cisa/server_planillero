...
async function main() {
  ...
  // 3) Seed Jobs
  const jobsToSeed = [
    { empresa: 'CopEnergy',   nombre: 'Operator',        codigo: 'OPR',  descripcion: 'Operador de sala' },
    { empresa: 'CopEnergy',   nombre: 'Technician',      codigo: 'TECH', descripcion: 'Técnico de control' },
    { empresa: 'Arrayan',      nombre: 'Developer',       codigo: 'DEV',  descripcion: 'Desarrollador software' },
    { empresa: 'Arrayan',      nombre: 'Electrician',     codigo: 'ELEC', descripcion: 'Técnico electricista' },
    { empresa: 'Arrayan',      nombre: 'Constructor',     codigo: 'CONS', descripcion: 'Obrero de construcción' },
    { empresa: 'IDSA',         nombre: 'Analyst',         codigo: 'ANL',  descripcion: 'Analista de datos' },
    { empresa: 'Linx',         nombre: 'Consultant',      codigo: 'CONS', descripcion: 'Consultor de sistemas' },
    { empresa: 'Fincasa',      nombre: 'Agronomist',      codigo: 'AGRO', descripcion: 'Ingeniero agrónomo' },
    { empresa: 'Durrikikara',  nombre: 'Chef',            codigo: 'CHEF', descripcion: 'Chef profesional' },
    { empresa: 'Durrikikara',  nombre: 'TourGuide',       codigo: 'TOUR', descripcion: 'Guía turístico' },
  ] as const;
